...
.pod-curve-fill {
  ...
  background: linear-gradient(
    ...
    color-mix(in srgb, var(--curve-fill-color) 70%, transparent) 20%,
    color-mix(in srgb, var(--curve-fill-color) 40%, transparent) 40%,
    color-mix(in srgb, var(--curve-fill-color) 10%, transparent) 50%,
    transparent 60%
  );
